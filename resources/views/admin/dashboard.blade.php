                                    ...
                                    @foreach ($student_info as $iteam)
                                        ...
                                        @if ($iteam->student->accept == 0)
                                            ...
                                            <tr>
                                                ...
                                                <th>
                                                    {{-- الموافقة على الطالب --}}
                                                    <a href="{{ URL::route('accept', [$iteam->student->id]) }}" type="button"
                                                        class="btn btn">
                                                        <i href="{{ URL::route('accept', [$iteam->student->id]) }}" type="button"
                                                            class="material-icons" title="قبول">&#10003;</i>
                                                    </a>
                                                    {{-- رفض الطالب  --}}
                                                    <a href="{{ URL::route('Trashdelete', [$iteam->student->id]) }}"
                                                        type="button" class="btn btn">
                                                        <i href="{{ URL::route('Trashdelete', [$iteam->student->id]) }}"
