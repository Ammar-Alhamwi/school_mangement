...
<body>
    <div class="main-container">
        ...
        <form action="{{ route('studentsave.sesone1')}}"method="POST"enctype="multipart/form-data">
            @csrf
            <div class="title">
            ...
            <div class="info" style="direction: rtl;">
                {{-- ادخال علامات الطالب  --}}
                <input type="text" class="fname" name="name_sub" placeholder=" اسم الماده "/>
                 <input type="text" class="fname" name="value" placeholder="علامة المادة"/>
                 <input type="text" class="fname" name="name_sub" placeholder="اسم الماده  "/>
                 <input type="text" class="fname" name="value" placeholder="علامة الماده  "/>
                 <input type="text" class="fname" name="name_sub" placeholder=" اسم الماده "/>
                 <input type="text" class="fname" name="value" placeholder="علامة المادة"/>
                 <input type="text" class="fname" name="name_sub" placeholder="اسم الماده  "/>
                 <input type="text" class="fname" name="value" placeholder="علامة الماده  "/>
