					   ...
					   <table class="table table-striped table-hover">
						  ...
						  <tbody>
                            @foreach ($student_info as $iteam)
                                        ...
                                        @endphp
                                        @if ($iteam->student->accept == 1 and $iteam->student->age== 1 )
						      <tr>
							 ...
							 <th><span class="custom-checkbox">
								...
								<th>
                                    <a href="/insertmarks" class="btn success">ادخال</a>
												...
												<div class="modal-dialog" role="document">
												  <div class="modal-content">
													<div class="modal-header">
													  ...
													  <button href="/insertmarks" type="button" class="close" data-dismiss="modal" aria-label="Close">
