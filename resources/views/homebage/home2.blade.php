      ...
      <div class="col-lg-8 col-md-12 col-12 ps-lg-5 mt-md-5">
        <div class="about-text">
          ...
          <p>
            ...
            <br>
            هدفنا الاساسي:إعداد جيل متفوق واثق من نفسه يتمتع بالأخلاق الحميدة يمتلك جوانب القيادة والإبداع ومهارات الحياة والاعتماد على أسلوب تربوي متطور تحت رعاية مدرسين</p>
        </div>
      </div>
    </div>
  </div>
