            ...
            <span>
                <div class="content">
                    ...
                    <p>
                        ...
                        <br>
                        <br>
                        عدد المقاعد في كل شعبة : 20
                        <br>
                        <br>
                        عدد الطلاب في كل مقعد :2
                    </p>
                    <form action="{{ route('show_sub')}}"method="POST"enctype="multipart/form-data">
                        @csrf
                    <button class="btn btn-primary" type="submit" name='id' value={{$item->id}}>الاطلاع على المناهج الدراسية للصف الاول </a></button>
                    </form>
                </div>
            </span>
        </div>
